...
export const welcomeContent = (__) => {

    return `
        ${ stepsContent(__) }
          <div class="container kp " style="max-width:740px;margin:auto;">
              <div class="row g-2 mb-4">
                  <h2 class="mt-4 mb-0">${ __('ATA Carnet Application') }</h2>
                  ...
                  <p>${ __('You can find your previous applications under my account page or start creating a new application by clicking on %1$start application%2$ button below.', '<b>', '</b>') }</p> 
              </div>
